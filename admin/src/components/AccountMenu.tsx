  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      >
        ...
        <span className="hidden max-w-[140px] truncate font-medium text-slate-800 sm:block">{user?.fullName}</span>
      ...
      {open && (
        ...
        >
          <div className="border-b border-slate-100 px-4 py-3">
            ...
            <p className="mt-1 text-[11px] font-medium uppercase tracking-wide text-indigo-600">Super Admin</p>
          </div>
          <button
            type="button"
            role="menuitem"
