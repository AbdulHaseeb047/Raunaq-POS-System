...
export function IconSale(p: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} {...p}>
...
export function IconSupplier(p: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} {...p}>
...
/** Sidebar panel toggle — rounded frame with left rail (matches reference). */
export function IconSidebarPanel(p: IconProps) {
  return (
